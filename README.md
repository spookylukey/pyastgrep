# pyastgrep
[![PyPI version](https://badge.fury.io/py/pyastgrep.svg)](https://badge.fury.io/py/pyastgrep)
...
*  `ast` module documentation for [Python 3.X](https://docs.python.org/3/library/ast.html).
...
This project was forked from https://github.com/hchasestevens/astpath by [H. Chase Stevens](http://www.chasestevens.com)
